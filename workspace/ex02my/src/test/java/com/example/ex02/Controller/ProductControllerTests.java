...
public class ProductControllerTests {
    ...
    public void registerTest() throws  Exception{
        log.info(mockMvc.perform(MockMvcRequestBuilders.get("/product/register"))
                .andReturn().getModelAndView().getModelMap().toString()); // mockVc.perfom() = 브라우저 실행
    ...
    public void updateTest() throws  Exception {
        log.info(mockMvc.perform(MockMvcRequestBuilders.get("/product/update")
                .param("productId", "3")).andReturn().getModelAndView().getViewName());

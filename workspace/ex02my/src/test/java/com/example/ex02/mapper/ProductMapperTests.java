...
//    ProductVO productVO;
    ...
    public void insertTest(){
        ...
        productVO.setProductName("사탕");
        productVO.setProductPrice(500);
...
//        Assertions.assertThat() 작성 후, assertThat에서 alt enter로 static import 가능.
    ...
    public void selectTest(){
        assertThat(productMapper.select(3L).getProductName()).isEmpty();
    }

    @Test
    public void selectAllTest(){
        assertThat(productMapper.selectAll().get(0).getProductName()).isEqualTo("사탕");
    }
